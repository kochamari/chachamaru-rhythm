...
p=argparse.ArgumentParser();p.add_argument('source');p.add_argument('directory');p.add_argument('title');p.add_argument('artist');p.add_argument('--name',default='');a=p.parse_args()
...
try:analyze(a.source,directory,a.title,a.artist,progress,a.name)
